...
handleSubmit() {
  ...
  'Content-Type': 'application/json',
    ...
    body: JSON.stringify({
      ...
      click: d.state.click,
      sumsum: d.state.verysad + d.state.sad + d.state.tja + d.state.happy + d.state.veryhappy,
      rate: d.state.sum / d.state.click,
    })
  })
    ...
    <content class='container'>
      ...
      {!this.state.isDisable &&   <div class='todays' >
          ...
          <p>Click siden sidste reset {totaltClick} </p><br />
            ...
            <input type="button" value="hide" class='hide' onClick={this.hide.bind(this)} onChange={this.sendData} />
